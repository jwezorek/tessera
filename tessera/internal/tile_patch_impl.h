...
namespace tess {
    ...
    namespace detail {
        ...
        public:
            ...
            expr_value get_on(allocator& a, const std::variant<tess::const_edge_ptr, tess::const_cluster_ptr>& e) const;
    ...
    const_patch_ptr flatten(allocator& a, const std::vector<expr_value>& tiles_and_patches, bool should_join_broken_tiles);
    const_tile_ptr join(allocator& a, const std::vector<expr_value>& tiles_and_patches, bool should_join_broken_tiles);
