...
namespace tess {
    ...
    namespace geometry {
        ...
        using segment_rtree_value = std::pair<segment, tess::const_edge_ptr>;
    ...
    public:
        ...
        void insert(tess::const_edge_ptr edge);
        std::vector<tess::const_edge_ptr> get(tess::point a, tess::point b);
        std::vector<tess::const_edge_ptr> get(const tess::edge& edge);
        std::vector<tess::const_edge_ptr> get(tess::const_edge_ptr edge);
    private:
        number eps_;
    ...
    std::vector<point> join(tess::const_patch_ptr tiles);
