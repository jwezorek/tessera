...
private:
	 tess::execution_ctxt& ctxt_;
public:
	object_ref_item_visitor( tess::execution_ctxt& ctxt) : ctxt_(ctxt)
	{}
...
tess::expr_value tess::object_ref_expr::eval( tess::execution_ctxt& ctxt) const 
{
