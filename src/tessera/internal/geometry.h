...
namespace tess {
    ...
    namespace geometry {
        ...
        using segment_rtree_value = std::pair<segment, tess::const_edge_root_ptr>;
    ...
    public:
        ...
        std::vector<tess::const_edge_root_ptr> get(tess::const_edge_root_ptr edge);
    private:
        number eps_;
    ...
    std::vector<point> join(tess::const_patch_root_ptr tiles);
